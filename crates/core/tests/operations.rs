...
// TODO-MUST-FIX: This test has fundamental race conditions in subscription propagation logic
...
// This needs proper implementation of cross-node subscription propagation.
// See issue #1798 for details and tracking.
#[tokio::test(flavor = "multi_thread", worker_threads = 4)]
#[ignore = "Flaky test with race conditions - see TODO-MUST-FIX above"]
